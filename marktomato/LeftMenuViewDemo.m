...
//    [imageview setBackgroundColor:[UIColor redColor]];
    ...
    //添加尾部
    UIView *footerView = [[UIView alloc]initWithFrame:CGRectMake(0, self.frame.size.height, Frame_Width, 50)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (indexPath.row) {
        case 0:
        {
            [cell.imageView setImage:[UIImage imageNamed:@"关于"]];
        ...
        case 1:
        {
            ...
            [cell.imageView setImage:[UIImage imageNamed:@"书本书签"]];
            [cell.textLabel setText:@"红薯便签"];
        }
            break;
